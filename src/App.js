...
function App () {
  ...
  const handleInProgress = index => {
    ...
    localStorage.setItem('inProgressTodos', JSON.stringify(updatedInProgressArr));
  };
  ...
  const handleProgressComplete = index => {
    let now = new Date();
    let dd = now.getDate();
    let mm = now.getMonth() + 1;
    let yyyy = now.getFullYear();
    ...
    // Remove the item from in-progress tasks
    let updatedInProgressArr = [...inProgressTodos];
  ...
  return (
    <div className="App">
      <h1>Dynamic ToDo List Application</h1>
      <div className="todo-wrapper">
        ...
        <div className="btn-area">
          ...
          <button
            className={`secondaryBtn ${isCompleteScreen === 'pending' ? 'active' : ''}`}
            onClick={() => setIsCompleteScreen('pending')}
          >
            Pending
          </button>
          <button
                  ...
                  <div className="todo-list-item" key={index}>
                    ...
                    <div>
                      ...
                      <BsCheckLg
                        ...
                        onClick={() => handleInProgress (index)}
                        title="InProgress?"
                      />
                      <BsCheckLg
